...
<section class="product-table">
    <div class="container-fluid">
        ...
        <table>
            ...
            <tbody>
            <tr class="tr-green">
                <td data-label="Пакет">START</td>
                <td data-label="Балл">QV-50, BV-25</td>
                <td data-label="Цена">100$</td>
                <td data-label="Товары" class="td-img"><img src="img/Пакеты/Бизнес-min.png" alt=""></td>
                <td data-label="Линейка продукции" class="td-200"><p>2 ENERGY BAR, OMEGA PLUS или OPTI PHLEX 2 ENERGY BAR, OMEGA PLUS или OPTI PHLEX</p></td>
                ...
                <td data-label="Купить"><a class="btn-plain btn-buy">Купить</a></td>
            </tr>
            <tr class="tr-green-dark">
                <td scope="row" data-label="Пакет">ECONOM</td>
                <td data-label="Балл">QV-50, BV-25</td>
                <td data-label="Цена">100$</td>
                <td data-label="Товары" class="td-img"><img src="img/Пакеты/Бизнес-min.png" alt=""></td>
                <td data-label="Линейка продукции">2 ENERGY BAR, OMEGA PLUS или OPTI PHLEX</td>
                <td data-label="Возможности дохода">
                    <ul>
                        <li>Реферальный бонус</li>
                        <li>Реферальный бонус</li>
                        <li>Реферальный бонус</li>
            ...
            <tr class="tr-pink">
                <td scope="row" data-label="Пакет">STANDART</td>
                <td data-label="Балл">QV-50, BV-25</td>
                <td data-label="Цена">100$</td>
                <td data-label="Товары" class="td-img"><img src="img/Пакеты/Бизнес-min.png" alt=""></td>
                <td data-label="Линейка продукции">2 ENERGY BAR, OMEGA PLUS или OPTI PHLEX</td>
            ...
            <tr class="tr-blue">
                <td scope="row" data-label="Пакет">BUSINESS</td>
                <td data-label="Балл">QV-50, BV-25</td>
                <td data-label="Цена">100$</td>
                <td data-label="Товары" class="td-img"><img src="img/Пакеты/Бизнес-min.png" alt=""></td>
                <td data-label="Линейка продукции">2 ENERGY BAR, OMEGA PLUS или OPTI PHLEX</td>
            ...
            <tr class="tr-red">
                <td scope="row" data-label="Пакет">PLATINUM</td>
                <td data-label="Балл">QV-50, BV-25</td>
                <td data-label="Цена">100$</td>
                <td data-label="Товары" class="td-img"><img src="img/Пакеты/Бизнес-min.png" alt=""></td>
                <td data-label="Линейка продукции">2 ENERGY BAR, OMEGA PLUS или OPTI PHLEX</td>
