                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-block">
                            <form action="{{url('package')}}" method="POST" class="form-horizontal  form-material user_create">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="{{ old('goods') }}" name="goods" class="form-control form-control-line">
                                        @if ($errors->has('goods'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="{{ old('income') }}" name="income" class="form-control form-control-line">
                                    ...
                                    <div class="col-md-12">
                                        <select class="custom-select form-control required" id="rank" name="rank">
                                            @foreach(\App\Models\Status::all() as $item)
                                                <option value="{{ $item->id }}" @if(old('rank') == $item->id) selected @endif>{{ $item->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="custom-select form-control required" id="status" name="status">
                                            ...
                                            <option value="0"  @if(old('status') == 0) selected @endif>Нет</option>
                                            <option value="1"  @if(old('status') == 1) selected @endif>Да</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
