                    ...
                    <div class="col-md-12">
                        <div class="pull-left">
                            <address>
                                ...
                                <p class="text-muted m-l-5">{{ \App\Models\Package::find(Auth::user()->package_id)->title }}, {{ \App\Models\Status::find($user_program->status_id)->title }}
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($goods as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->title }}</td>
                                        <td  class="text-right">
                                            <button style="background:transparent;border:none;" onclick="addBasket(this,{{ $item->id }},1,{{$key}},true,false,false)">
                                                <i  class="fa fa-plus-circle" aria-hidden="true"></i>
                                            </button>
                                            <span id="q{{$item->id}}">{{ $item->quantity }}</span>
                                            <button class="minusButton" style="background:transparent;border:none;" onclick="addBasket(this,{{ $item->id }},1,{{$key}},false,true,false)">
                                        ...
                                        <td class="text-right">
                                            <button style="background:transparent;border:none;" onclick="addBasket(this,{{ $item->id }},1,{{$key}},false,false,true)">
                                                delete
                                            </button>
                                        </td>
                                    </tr>
