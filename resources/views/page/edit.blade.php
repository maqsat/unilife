                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-block">
                            <form action="{{url('page', [$page->id])}}" method="POST" class="form-horizontal form-material">
                                {{ method_field('PATCH') }}
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label class="col-md-12">Наименование</label>
                                    <div class="col-md-12">
                                        <input type="text" value="{{ $page->title }}" name="title" class="form-control form-control-line">
                                        @if ($errors->has('title'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea class="form-control form-control-lin"  name="content" rows="6" id="editor">{{ $page->content }}</textarea>
                                    </div>
                                </div>
