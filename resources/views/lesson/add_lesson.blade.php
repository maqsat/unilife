    ...
    <div class="page-wrapper" style="background: #f2f7f8;">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Добавить урок</h3>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-block">
                        <form action="/{{$course_id}}/lessons" method="POST" class="form-horizontal form-material"  enctype="multipart/form-data">
                            {{ csrf_field() }}
