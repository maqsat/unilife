                        ...
                        <div class="card-block">
                            <table class="table color-table success-table">
                                ...
                                @foreach($reviews as $key => $item)
                                    ...
                                    <td>@if($item->approved === 1) Подтвержденый @elseif($item->approved === 0) Не подтвержденый @else Новый @endif</td>
                                    <td class="actions">
                                        <a href="/admin/review/{{ $item->id }}/approved" class="btn btn-xs btn-success action approved" title="Подтвердить"><i class="mdi mdi-check"></i></a>
                                        <a href="/admin/review/{{ $item->id }}/cancel" class="btn btn-xs btn-warning action cancel" title="Отменить"><i class="mdi mdi-block-helper"></i></a>
                                        <a href="{{route('admin_review_edit', [ 'id' => $item->id ])}}" class="btn btn-xs btn-success" title="Изменить"><i class="mdi mdi-grease-pencil" ></i></a>
