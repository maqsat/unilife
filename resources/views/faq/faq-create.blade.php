            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-block">
                        <form action="/faqadmin" method="POST" class="form-horizontal form-material" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label class="col-md-12">Вопрос</label>
                                <div class="col-md-12">
                                    <input type="text" value="{{ old('title') }}" name="question" class="form-control form-control-line">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea class="form-control form-control-lin"  name="answer" rows="6"  id="editor">{{ old('description') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="is_admin" >
                                    ...
                                    <option value="0">Для гостя</option>
                                </select>
