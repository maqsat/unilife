            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-block">
                        <form action="/course/{{$course->id}}" method="POST" class="form-horizontal form-material"  enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @method('put')
                            <div class="form-group">
                                <label class="col-md-12">Название</label>
                                <div class="col-md-12">
                                    <input type="text"  name="title" class="form-control form-control-line" value="{{$course->title}}">
                                    @if ($errors->has('title'))
