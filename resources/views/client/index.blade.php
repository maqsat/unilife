                                ...
                                <table class="table color-table success-table">
                                    ...
                                    @foreach($list as $item)
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <a href="/user/{{ $item->id }}" target="_blank" class="btn btn-info">
                                                    <i class="mdi mdi-eye"></i>
                                                </a>
                                                <a href="/user/{{ $item->id }}/edit" class="btn btn-success">
                                                    <i class="mdi mdi-grease-pencil"></i>
                                                </a>
                                                <form action="{{url('user', [$item->id])}}" method="POST">
                                                    {{ method_field('DELETE') }}
                                                    {{ csrf_field() }}
                                                    <button type="submit" class="btn btn-danger" onclick="return deleteAlert();">
